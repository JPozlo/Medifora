...
class HomeFeedAdapter(private val homeQuestionsArrayList: ArrayList<Question>): RecyclerView.Adapter<HomeFeedAdapter.HomeFeedViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeFeedAdapter.HomeFeedViewHolder, position: Int) {
        ...
        holder.itemView.tvHomeFeedAnswersItem.text = question.answer
    }
}